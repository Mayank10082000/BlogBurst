...
// signup and login on the right of the navbar
...
/* When a person logs in to there account, the navbar should contain below contents:
 ...
 2. Profile icon, logout button, my dashboard button, and community blogs button on the right of the navbar, make their sizes small to optimize space or just use icons if possible
 */
